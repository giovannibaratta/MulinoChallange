...
//		}
		...
		// from the wiki:
		// "Vince il primo giocatore che lascia l'avversario con meno di tre pezzi in gioco o senza possibilit� di muovere."
		// condition "senza possibilit� di muovere" will be captured by the timeout
