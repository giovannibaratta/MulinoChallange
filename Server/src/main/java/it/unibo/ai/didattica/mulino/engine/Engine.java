...
/**
 * Server per il gioco del it.unibo.ai.didattica.mulino
 * 
...
public class Engine {
	...
	private static Checker currentPlayer;
	...
	/**
     * Crea una partita del gioco del it.unibo.ai.didattica.mulino
	 * 
	 * @param timeout
	...
	public void run() throws IOException {
		...
		whiteSocket = new TCPMulino(Checker.WHITE);
		whiteSocket.writeState(currentState);
		blackSocket = new TCPMulino(Checker.BLACK);
		...
		while (true) {
			...
			currentPlayer = (currentPlayer == Checker.WHITE) ? Checker.BLACK : Checker.WHITE;
		}
