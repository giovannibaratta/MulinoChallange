...
/**
 * Configurazioni supportate dal client
 */
enum class Algorithm {
    QLEARNING,
    MINMAX, // min max con tempo impostato a default
    QLEARNINGNOSAVE,
    QLEARNINGAPPRENDIMENTO,
    MINMAX5, // min max con tempo impostato a 5 secondi
    MINMAX10, // min max con tempo impostato a 10 secondi
    TRAINERMINMAX,
    MINMAX2 // min max con tempo impostato a 2 secondi
}
