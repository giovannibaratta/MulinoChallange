...
//
//    private val closedMorris = { oldState: MinMaxState, action: String, newState: MinMaxState ->
...
//            )
//
//    private val featuresPhase3: Array<(MinMaxState, String, MinMaxState) -> Double> =
//            arrayOf(
//                    closedMorris,
//                    num2Pieces,
//                    num3Pieces,
...
//      }
//  */
//    private val actionFromStatePhase1: (MinMaxState) -> MutableList<String> = { s ->
//        MulinoGame.getActions(s)
//    }
//
//    private val actionFromStatePhase2: (MinMaxState) -> MutableList<String> = { s ->
//        MulinoGame.getActions(s)
//    }
//
//    private val actionFromStatePhase3: (MinMaxState) -> MutableList<String> = { s ->
//        MulinoGame.getActions(s)
//    }
//
//    //</editor-fold desc="Features">
//
//    private val applyAction: ((MinMaxState, String, MinMaxState) -> Double) -> (MinMaxState, String) -> Pair<Double, MinMaxState> = {
...
//
//    private val learnerPhase1 = ApproximateQLearning<MinMaxState, String>(
//            alpha,
...
//
//    private val learnerPhase2 = ApproximateQLearning<MinMaxState, String>(
//            alpha,
//            { discount },
...
//
//    private val learnerPhase3 = ApproximateQLearning<MinMaxState, String>(
//            alpha,
//            { discount },
...
//            applyAction = applyAction(phase1Reward))
//
//    fun playPhase1(state: MinMaxState, actions: MutableList<String>) =
//            learnerPhase1.think(state, actions)
//
//    fun playPhase2(state: MinMaxState, actions: MutableList<String>) =
//            learnerPhase2.think(state, actions)
//
//    fun playPhase3(state: MinMaxState, actions: MutableList<String>) =
